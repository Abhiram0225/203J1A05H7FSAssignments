...
let n: number = 49
console.log(n)
let s: string = "Abhiram"
console.log(s)
let b: boolean = true
console.log(b)
let arrofnum: number[] = [4,5,23]
console.log(arrofnum)
let tupleofele: [string,number]=["Bhuwanesh",14]
...
console.log(capitalize("good morning abhiram"))
...
console.log(reverseArray(["Abhiram","Bhuwanesh",49,14]))